...
def pregunta_01():
    ...
    df = pd.read_csv(
        # 'C:/Users/jlopezl/OneDrive - Renting Colombia S.A/Archivos/Personal/Especializaci�n/Ciencia de los datos/analisis-de-sentimientos-amazon-JuanesLopez/amazon_cells_labelled.tsv',
...
def pregunta_05():
    ...
    # Eval�e el pipeline con los datos de entrenamiento usando la matriz de confusion.
    cfm_train = 
    )
